TaxCloud PHP Integration - based on 01/10/16 version from Github, updated for Zen Cart v1.5.5f


This version of the integration will only work with Zen Cart v1.5+! Use the v1.4* versions for Zen Cart v1.3.9.

For installation instructions, please visit https://taxcloud.net/guide/ and select the Zen Cart Quickstart Guide. 
